...
<html amp>
	...
	<body>
		...
		<amp-sidebar id="sidebar" layout="nodisplay"  side="right" >
			...
			<ul class="">
				<li><a href="<?php echo BASEURL; ?>">முகப்பு</a></li>
				<li><a href="<?php echo BASEURL; ?>latest-news">தற்போதைய செய்திகள்</a></li>
				<li><a href="<?php echo BASEURL; ?>editorial"> தலையங்கம்</a></li>
				<li><a href="<?php echo BASEURL; ?>india"> இந்தியா</a></li>
				<li><a href="<?php echo BASEURL; ?>cinema"> சினிமா</a></li>
				<li><a href="<?php echo BASEURL; ?>sports">விளையாட்டு</a></li>
				<li><a href="<?php echo BASEURL; ?>religion">ஆன்மிகம்</a></li>
				<li><a href="<?php echo BASEURL; ?>astrology">ஜோதிடம்</a></li>
				<li><a href="<?php echo BASEURL; ?>employment">வேலைவாய்ப்பு</a></li>
				<li><a href="<?php echo BASEURL; ?>tamilnadu">தமிழ்நாடு</a></li>
				<li><a href="<?php echo BASEURL; ?>world">உலகம்</a></li>
				<li><a href="<?php echo BASEURL; ?>education">கல்வி</a></li>
				<li><a href="<?php echo BASEURL; ?>lifestyle">லைஃப்ஸ்டைல்</a></li>
			</ul>
		</amp-sidebar>
		<div style="max-width: 600px; margin: 0 auto;">
			...
			<nav>
				...
				foreach($menuDetails as $menu):
					if(strtolower($menu['Sectionname'])=='முகப்பு'){
