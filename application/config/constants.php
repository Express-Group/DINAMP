...
define('source_base_path', '/images/din_images/');
define('destination_base_path', '/images/din_images/');
...
define('image_url', 'https://images.dinamani.com/');
define('image_url_no', 'http://images.dinamani.com/');
define('BASEURL', 'https://www.dinamani.com/');
define('HOMEURL', 'http://www.dinamani.com/');
define('AMPURL', 'www.dinamani.com/'); 
define('MOBILEURL', 'https://m.dinamani.com/'); 
